...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'typescript', 'help', 'java', 'html' },
...
-- Run make with F9
vim.api.nvim_set_keymap('n', '<F9>', ':terminal make<CR>:startinsert<CR>', { noremap = true, silent = true })
