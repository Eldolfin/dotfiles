...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'typescript', 'help', 'java', 'html', 'bash', 'css', 'gitignore', 'make'},
...
-- Run make with F9
vim.api.nvim_set_keymap('n', '<F9>', ':w | terminal make<CR>:mode insert', { noremap = true, silent = true })
