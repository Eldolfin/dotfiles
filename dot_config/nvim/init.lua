...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'typescript', 'help', 'java', 'html', 'htmldjango', 'bash', 'css', 'gitignore', 'make'},
...
-- F6 to fuzzy find file
vim.api.nvim_set_keymap('n', '<F6>', '::Telescope find_files<CR>', { noremap = true, silent = true })

-- Run make with F9
vim.api.nvim_set_keymap('n', '<F9>', ':w | vertical terminal make<CR>:startinsert<CR>', { noremap = true, silent = true })
